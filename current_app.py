...
class_labels = [
    ...
    'Gandhi Ghat Patna', 'Ghora Katora lake', 'Golghar', 'Griddhakuta (Vulture\'s Peak)', 
    'Hot Spring Rajgir', 'Ibrahim Baya Maqbara Nalanda', 'International Conventional Hall Rajgir', 
    'Jain Temple Kundalpur', 'Jal Mandir in Pawapuri', 'Japani mandir Rajgir', 
    'Jarasandha ka Akhara in Nalanda', 'Kesariya Stupa', 'Mahabodhi Temple', 'Maner Sharief', 
    'Mundeshwari Devi Temple Kaimur', 'Pandu Pokhar Rajgir', 'Ruins of Nalanda University', 
    'Ruins of Vikramshila University', 'Sher Shah Suri Tomb', 'Shri Vishnupad Temple Gaya', 
    'Son bhandar', 'Sujata Kutir Buddhist Stupa Gaya', 'Takhat Shri Harimandir Ji Patna Sahib', 
    'Tapovan Gaya', 'Thai Mandir Buddhist Monastery', 'Vaishali Shanti Stupa', 
    'Veerayatan Jain Institute', 'Venuvan Rajgir', 'Vishwa Shanti Stupa Nalanda'
]  # Updated class names with new monument labels

# Set up the title and description
st.title("Monument Recognition")
st.write("This model is trained on the following monument categories: ")
st.write(", ".join(i+'\n' for i in class_labels))  # Display all class labels as a list
st.write("Please upload an image that corresponds to one of these monuments for accurate predictions.")
